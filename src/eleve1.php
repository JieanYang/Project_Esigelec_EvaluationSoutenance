...
<form class="note" method="post" action="eleve1.php">
<h4>Pour quelle date voulez vous consulter une soutenance?</h4>
 
<p><select date="date_soute" onchange="javascript:submit(this)"required >
 
<?php
$reponse = $bdd->query('SELECT * FROM soutenance ');
